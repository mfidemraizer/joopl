/*
	Copyright 2013 Matías Fidemraizer (http://www.linkedin.com/in/mfidemraizer)
...
module.exports = function (grunt) {
  grunt.registerMultiTask(
	...
	function () {
		var done = this.async();
		var classes = require("joopl-analyzer");
		...
		if(this.data.hasOwnProperty("watch") && this.data.watch == true) {
			var watchr = require("watchr");
			
			watchr.watch({
				path: this.data.baseDirectory,
				listeners: {
					change: function(changeType, filePath, fileCurrentStat, filePreviousStat) {
						if(filePath.indexOf("moduleinfo.js") == -1) {
							analyzer.start({ baseDirectory: this.data.baseDirectory });
						}
		        	}
				}
			});
