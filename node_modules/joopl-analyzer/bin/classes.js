...
DependencyMapBuilder.prototype = {
                                ...
                                if(typeof callee.object != "undefined")
                                {
                                    ...
                                    // When registering a new namespace...
                                        ...
                                        if(namespaceScope != null) {
                                            that.parseNamespaceScopeAstSync(namespaceScope, namespaces[namespacePath], sourceFile, namespaces);
                                        }
                                    }
                                }
                                break;
    ...
    parseNamespaceScopeAstSync: function(ast, namespace, sourceFile, namespaces) {
        var that = this;
                ...
                case "ExpressionStatement":
                    switch(node.expression.type) {
                        case "CallExpression":
                            ...
                            if(typeof callee.object.type != "undefined" && callee.object.name == "$namespace") {
                                that.parseAstSync(sourceFile, [node], namespaces);
                            }
                ...
                case "ExpressionStatement":
                    switch(node.expression.type) {
                        ...
                        case "NewExpression":
                            ...
                            if(callee.type == "MemberExpression") {
                                if(typeof callee.object.type != "undefined" && callee.object.name == "$namespace") {
                                    that.getDependentFilesFromAstSync(parsedFile, [node], namespaces, dependentFiles);
                                }
