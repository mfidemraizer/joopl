...
DependencyAnalyzer.prototype = {
    start: function (args) {
        ...
        this.loadFilesAsync(args.baseDirectory).then(function (result) {
            ...
            that._map = mapBuilder.buildSync(result.sourceFiles, args.baseDirectory, result.includes);
    ...
    loadFilesAsync: function (baseUri) {
        ...
        walker.on("end", function () {
            ...
            if (DependencyAnalyzer.configuration.hasOwnProperty("includes") && DependencyAnalyzer.configuration.includes.length > 0) {
