        ...
        get: function() {
            if (!this.hasOwnProperty("_configuration")) {
                ...
                if (fs.existsSync(configurationUri)) {
                    configuration = JSON.parse(fs.readFileSync(configurationUri, "utf-8"));
                } else {
                    configuration = {
                        fileExcludes: []
                    };
...
DependencyAnalyzer.prototype = {
    ...
    loadFilesAsync: function (baseUri) {
        ...
        walker.on("file", function (root, stat, next) {
            ...
            var isExcluded = DependencyAnalyzer.configuration.fileExcludes.indexOf(fullFileName) == -1;
...
DependencyMapBuilder.prototype = {
                            ...
                            case "MemberExpression":
                                if (typeof callee.object != "undefined") {
                                    if (callee.object.name == "$import" && callee.property.name == "modules") {
                                        ...
                                        that.parseNamespaceScopeAstSync(namespaceScope, sourceFile, namespaces, namespaceAliases);
                                    }
                                }
                                break;
                        }
    ...
    parseNamespaceScopeAstSync: function (ast, sourceFile, namespaces, namespaceAliases) {
        var that = this;
                            ...
                            case "MemberExpression":
                                if (typeof callee.object != "undefined") {
                                    if (callee.object.name == "$import" && callee.property.name == "modules") {
                                        ...
                                        that.detectMembersFromNamespaceScopeSync(parsedFile, namespaceScopeAst, namespaceAliases, namespaces, dependentFiles);
                                    }
                                }
                                break;
                        }
    ...
    detectMembersFromNamespaceScopeSync: function (parsedFile, namespaceScopeAst, namespaceAliases, namespaces, dependentFiles) {
        var that = this;
                    ...
                    switch (node.expression.type) {
                        ...
                        case "NewExpression":
                            ...
                            if (callee.type == "MemberExpression") {
                                ...
                                var ns = namespaces[namespaceAliases[callee.object.name]];
                                                    ...
                                                    if (result != null) {
                                                        ...
                                                        result.forEach(function(newExpressionText) {
                                                            ...
                                                            case -1:
                                                                ...
                                                                foundMember = underscore.findWhere(namespaces[namespaceAliases[tempMemberName[0]]].members, { name: tempMemberName[1] });
