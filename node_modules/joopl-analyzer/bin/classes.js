...
DependencyAnalyzer.prototype = {
    start: function (args) {
        ...
        this.loadFilesAsync(args.baseDirectory).then(function (result) {
            var mapBuilder = new DependencyMapBuilder();
            that._map = mapBuilder.buildSync(result.sourceFiles, args.baseDirectory, typeof result.includes == "undefined" ? {} : result.includes);
    ...
    loadFilesAsync: function (baseUri) {
        ...
        var hasIncludes = DependencyAnalyzer.configuration.hasOwnProperty("includes") && DependencyAnalyzer.configuration.includes.length > 0;
