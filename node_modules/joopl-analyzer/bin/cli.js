...
program
    ...
    .option("-e, --excludes", "A semicolon-separated list of files or directory paths to exclude from the analysis.")
    .option("-o, --baseDirectoryOverrides", "A semicolon-separated list of key-value pairs where key is the base directory to override and the value is the expected result expression")
