...
exports.joopl_analyzer_ns4_SomeClass_hasExcpectedDependencies = function(test) {
	...
	test.ok(dependencies.indexOf("./test/test-hierarchy/ClassWithPropertiesAndInstances.js") == 0, "ClassWithPropertiesAndInstances class found and it has been detected in the right order");
	...
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns2/A.js") == 2, "ns2.A class found and it has been detected in the right order");
	...
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns3/C.js") == 4, "ns1.B class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns1/B.js") == 5, "ns3.C class found and it has been detected in the right order");
...
exports.joopl_analyzer_SomeClass_hasExpectedDependencies = function(test) {
	...
	test.ok(dependencies.indexOf("./test/test-hierarchy/SomeClass.js") == 2, "SomeClass class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns1/A.js") == 3, "ns1.A class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns1/B.js") == 4, "ns1.B class found and it has been detected in the right order");
...
exports.joopl_analyzer_ns6_SomeClass_hasExpectedDependencies = function(test) {
	...
	test.ok(dependencies.indexOf("./test/test-hierarchy/SomeClassUsesTestEnum.js") == 0, "SomeClassUsesTestEnum class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/SomeEnum.js") == 1, "SomeEnum class found and it has been detected in the right order");
...
exports.threeclasstest2_B_hasExpectedDependencies = function(test) {
	test.ok($import._dependencies.hasOwnProperty("threeclasstest2.B"), "threeclasstest2.B class has been detected");

	var dependencies = $import._dependencies["threeclasstest2.B"];

	test.equal(1, dependencies.length, "1 files should be the count of detected file dependencies");

	test.ok(dependencies.indexOf("./test/test-hierarchy/ThreeClassesDifferentNamespace.js") == 0, "threeclasstest2.B class found and it has been detected in the right order");

	test.done();
}

exports.threeclasstest3_C_hasExpectedDependencies = function(test) {
	test.ok($import._dependencies.hasOwnProperty("threeclasstest3.C"), "threeclasstest3.C class has been detected");

	var dependencies = $import._dependencies["threeclasstest3.C"];

	test.equal(1, dependencies.length, "1 files should be the count of detected file dependencies");

	test.ok(dependencies.indexOf("./test/test-hierarchy/ThreeClassesDifferentNamespace.js") == 0, "threeclasstest3.C class found and it has been detected in the right order");
...
exports.threeclasstest_B_hasExpectedDependencies = function(test) {
	test.ok($import._dependencies.hasOwnProperty("threeclasstest.B"), "threeclasstest.B class has been detected");

	var dependencies = $import._dependencies["threeclasstest.B"];

	test.equal(1, dependencies.length, "1 files should be the count of detected file dependencies");

	test.ok(dependencies.indexOf("./test/test-hierarchy/ThreeClassesSameNamespace.js") == 0, "threeclasstest.B class found and it has been detected in the right order");

	test.done();
}

exports.threeclasstest_C_hasExpectedDependencies = function(test) {
	test.ok($import._dependencies.hasOwnProperty("threeclasstest.C"), "threeclasstest.C class has been detected");

	var dependencies = $import._dependencies["threeclasstest.C"];

	test.equal(1, dependencies.length, "1 files should be the count of detected file dependencies");

	test.ok(dependencies.indexOf("./test/test-hierarchy/ThreeClassesSameNamespace.js") == 0, "threeclasstest.C class found and it has been detected in the right order");
...
exports.joopl_analyzer_ns3_C_hasExpectedDependencies = function(test) {
	...
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns2/A.js") == 0, "ns2.A class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns2/B.js") == 1, "ns2.B class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns3/C.js") == 2, "ns3.C class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns1/A.js") == 3, "ns1.A class found and it has been detected in the right order");
	test.ok(dependencies.indexOf("./test/test-hierarchy/ns1/B.js") == 4, "ns1.B class found and it has been detected in the right order");
