...
exports.joopl_analyzer_ns4_SomeClass_hasExpectedDependencies = function(test) {
	...
	test.equal(0, dependencies.indexOf("./test/test-hierarchy/ns2/A.js"), "ns2.A class found and it has been detected in the right order");
	test.equal(1, dependencies.indexOf("./test/test-hierarchy/ns2/B.js"), "ns2.B class found and it has been detected in the right order");
	...
	test.equal(3, dependencies.indexOf("./test/test-hierarchy/ns1/B.js"), "ns1.B class found and it has been detected in the right order");
	test.equal(4, dependencies.indexOf("./test/test-hierarchy/ns3/C.js"), "ns3.C class found and it has been detected in the right order");
